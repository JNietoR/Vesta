...
-->
    ...
    <footer class="bg-black black-gradiant">
        <div class="mx-auto black-gradiant  fw  max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="lg:flex lg:items-start lg:gap-8">
                <div class="text-teal-600">
                   <img class="border-img black-gradiant "src="../../../public/assets/logo/Fotico1final.png" alt="icono">
                </div>

                <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                    <div class="col-span-2">
                        <div>
                            <h2 class="text-2xl font-bold text-white">Subscríbete para conocer las novedades de Vesta!</h2>

                            <p class="mt-4 text-white">
                                Actualizaciones de sistema, nuevas versiones, mejoras y mucho más.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                        <form class="w-full">
                            ...
                            <div class=" p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                                <input type="email" id="UserEmail" placeholder="Introduzca un correo electrónico válido"
                                    class="txt-input-email w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm" />

                                <button
                                    class=" btn-enviar mt-1 w-full  px-6 py-3 text-sm font-bold uppercase tracking-wide text-white  sm:mt-0 sm:w-auto sm:shrink-0">
                                    Sign Up
                                </button>
                            </div>
                        </form>
                    ...
                    <ul class="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
                        ...
                        <li>
                            <a href="https://github.com/JNietoR/Vesta" rel="noreferrer" target="_blank"
                                class="text-white transition hover:opacity-75">
            ...
            <div class="mt-8 border-t border-gray-100 pt-8">
                <div class="sm:flex sm:justify-between">
                    <p class="text-xs text-white">&copy; 2024. Vesta. Todos los derechos reservados.</p>
