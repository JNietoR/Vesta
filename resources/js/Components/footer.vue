...
-->
    ...
    <footer class="bg-black black-gradiant">
        <div class="mx-auto text-center black-gradiant  fw  max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="lg:flex lg:items-start lg:gap-8">
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        ...
                        <li>
                            <a href="#" class="text-white transition hover:opacity-75"> Manual de usuario </a>
                        </li>
                        <li></li>
                    </ul>
                </div>
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="/privacy" class="text-white transition hover:opacity-75"> Privacy </a>
