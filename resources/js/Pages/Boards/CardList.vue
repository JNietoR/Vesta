    ...
    <div>
        <div class="flex justify-between items-center px-3 py-2">
            ...
            <Menu as="div" class="relative z-10">
                <MenuButton class="grid place-content-center w-8 h-8 rounded-md hover:bg-gray-300">
                    <EllipsisHorizontalIcon class="w-5 h-5" Settings />
        ...
        <div class="flex overflow-hidden flex-col pb-3">
            <div ref="listRef" class="overflow-y-auto flex-1 px-3">
                <Draggable :disabled="!!store.editingCardId" v-model="cards" class="space-y-3" drag-class="drag"
                    ghost-class="ghost" group="cards" item-key="id" tag="ul" @change="onChange">
