    ...
    <div class="flex justify-center items-center">
        <blockquote>
            ...
            <div class="page">
                <div class="header">
                    <div class="container">
                        <h1 class="stext-3xl">Privacy Policy for Vesta</h1>
                    </div>
                </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or
                                        "Our" in this Agreement) refers to Vesta.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to Vesta, accessible from <a href="vesta.com"
                                            rel="external nofollow noopener" target="_blank">vesta.com</a></p>
                                </li>
                                <li>
