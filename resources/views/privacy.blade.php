   ...
   <blockquote>
        <p>
            ...
            <div class="page">
                <div class="header">
                <div class="container">
                <p class="title">Privacy Policy for Vesta</p>
                </div>
                </div>
                ...
                <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Vesta.</p>
                </li>
                <li>
                ...
                <li>
                <p><strong>Website</strong> refers to Vesta, accessible from <a href="vesta.com" rel="external nofollow noopener" target="_blank">vesta.com</a></p>
                </li>
                <li>
                ...
                <ul>
                <li>By email: contact@vesta.com</li>
                </ul>
                </div>
                </div>
                </div>
